...
$pdf->Cell(2,1,'kode_user','LR',0,'C',1);
$pdf->Cell(7,1,'nama_user','LR',0,'C',1);
$pdf->Cell(5,1,'username','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // kode_user
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // nama_user
  $pdf->Cell(5,1,$cell[$j][2],'B',0,'L'); // username
  $pdf->Cell(3,1,$cell[$j][3],'B',0,'L'); // password
  $pdf->Cell(1,1,$cell[$j][4],'B',0,'L'); // status
  $pdf->Ln();
}
$pdf->Output();
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
