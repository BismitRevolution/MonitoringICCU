...
if($_SESSION["cstatus"]=="Administrator"){ echo "
	  ...
	  <li><a href='index.php?mnu=log'><em class='fa fa-navicon'>&nbsp;</em>Log</a></li>
	    <li><a href='index.php?mnu=grafik'><em class='fa fa-navicon'>&nbsp;</em>Grafik</a></li>
...
";}
	  ...
	  <li><a href='index.php?mnu=perawatan'><em class='fa fa-clone'>&nbsp;</em>Perawatan</a></li>
	  <li><a href='index.php?mnu=plog'><em class='fa fa-navicon'>&nbsp;</em>Log</a></li>
	   <li><a href='index.php?mnu=grafik'><em class='fa fa-navicon'>&nbsp;</em>Grafik</a></li>
	  <li><a href='index.php?mnu=logout'><em class='fa fa-power-off'>&nbsp;</em> Logout</a></li>
...
";}
	  ...
	  <li><a href='index.php?mnu=dlog'><em class='fa fa-navicon'>&nbsp;</em>Log</a></li>
	   <li><a href='index.php?mnu=grafik'><em class='fa fa-navicon'>&nbsp;</em>Grafik</a></li>
	  <li><a href='index.php?mnu=logout'><em class='fa fa-power-off'>&nbsp;</em> Logout</a></li>
";}
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
            ...
            <?php 
					...
					else if($mnu=="grafik"){require_once"grafiklib.php";}
					else if($mnu=="grafiklib"){require_once"grafiklib.php";}
